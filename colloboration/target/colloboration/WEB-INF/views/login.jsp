                ...
                <div class="panel-body">
                   ...
                   <div class="error" style="color: #ff0000 ;">${error}</div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="j_username" class="form-control" id="user_name" placeholder="UserName" required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="password" class="col-sm-3 control-label">Password</label>
                            <div class="col-sm-9">
                                <input type="password" name="j_password" class="form-control" id="password" placeholder="Password" required="true">
                            </div>
                        </div>
